...
function template_body_above()
{
	...
	{
		echo '
					<a href="', $scripturl, '?action=unread">', $txt['UnreadPosts'], '</a> | <a href="', $scripturl, '?action=unreadreplies">', $txt['NewTopics'], '</a>';
	}
	// Otherwise they're a guest - this time ask them to either register or login - lazy bums...
	elseif (!empty($context['show_login_bar']))
	{
		echo '
      <a href="', $scripturl, '?action=login">', $txt['GuestLogin'], '</a> | <a href="', $scripturl, '?action=register">', $txt['GuestRegister'], '</a>';
	}

	if ($context['user']['is_logged'] || !empty($context['show_login_bar']))
		echo '</span>
		<div class="header">
			<a href="', $scripturl, '/index.php"><img id="smflogo" src="', $settings['images_url'], '/logo.png" alt="Bryan Deakin.com Logo" /></a>
		</div>';
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">';
		// Removal of the theme copyright is illegal, to remove the copyright please email runic@simplemachines.org for prices of copyright removal (around $200 but discounts may be given)
		echo'
 			<li class="copyright">Blue Eyes by <a href="http://www.smfhacks.com" target="_blank">SMFHacks.com - SMF Mods</a></li>
