...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bordercolor">';
	...
	<tr><td style="padding: 1px 1px 0 1px;">';
		...
		echo '
							...
							<hr width="80%" size="1"  class="hrcolor" />
							<hr width="60%" size="1"  class="hrcolor" />
							<hr width="40%" size="1"  class="hrcolor" />
							<hr width="20%" size="1"  class="hrcolor" />
							<div><span class="smalltext"><b>', $message['member']['link'], '</b>&nbsp;',$txt['replied'],'</span></div>
