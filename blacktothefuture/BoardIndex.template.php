	...
	<table border="0" width="100%" cellspacing="0" cellpadding="5">
		<tr>
			<td align="', !$context['right_to_left'] ? 'left' : 'right', '" class="smalltext">
				<img src="' . $settings['images_url'] . '/on.gif" alt="', $txt[333], '" height="16px" width="16px" align="middle" /> ', $txt[333], '
				<img src="' . $settings['images_url'] . '/off.gif" alt="', $txt[334], '" height="16px" width="16px"  align="middle" style="margin-left: 4ex;" /> ', $txt[334], '
			</td>
