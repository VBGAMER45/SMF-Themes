...
<div id="mainframe"', !empty($settings['forum_width']) ? ' style="width: ' . $settings['forum_width'] . '"' : '', '>';
	...
	echo '
	<div class="tborder width commonback">
		<div class="logo">
			<img src="', !empty($settings['header_logo_url']) ? $settings['header_logo_url'] : $settings['images_url'] . '/ddlogo.gif', '" alt="" />
		</div>
		<div class="buttons">';
...
function template_body_below()
{
	...
	echo '
	<div class="footer">
				<a href="http://validator.w3.org/check/referer" target="_blank"><img src="', $settings['images_url'], '/valid-xhtml10.gif" alt="', $txt['valid_xhtml'], '" width="30" height="10" border="0" /></a>
				<a href="http://jigsaw.w3.org/css-validator/check/referer" target="_blank"><img src="', $settings['images_url'], '/valid-css.gif" alt="', $txt['valid_css'], '" width="30" height="10" border="0" /></a>
				<br />
				', theme_copyright(), '<br />Dark Day v3 by <a href="http://www.smfhacks.com" target="_blank">SMFHacks.com - SMF Mods</a>
	</div></div>
</div>';
}
		...
		echo '
			<li id="button_', $act, '"', !empty($classes) ? ' class="' . $classes . '"' : '', '>
				<a title="', !empty($button['alttitle']) ? $button['alttitle'] : $button['title'], '" href="', $button['href'], '"', isset($button['target']) ? ' target="' . $button['target'] . '"' : '', '>
					<span>', ($button['active_button'] ? '<em>' : ''), $button['title'], ($button['active_button'] ? '</em>' : ''), '</span><span>&nbsp;.:.&nbsp;</span>
				</a>
			</li>';
	}
