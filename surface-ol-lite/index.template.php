...
<head>';
	...
	echo '
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/style.responsive', $context['theme_variant'], '.css?fin20" />
	...
	if ($context['right_to_left'])
		echo '
		<link rel="stylesheet" href="', $settings['theme_url'], '/css/style.responsive.css" media="all" />
		<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Electrolize|Cuprum&amp;subset=latin" />
	...
	<script type="text/javascript" src="', $settings['default_theme_url'], '/scripts/script.js?fin20"></script>
	 ...
	 <script type="text/javascript" src="', $settings['theme_url'], '/scripts/script.responsive.js?fin20"></script>
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		...
		</ul> <p class="stm-page-footer">
		  <span id="stm-footnote-links">Designed by <a href="https://www.ezportal.com" target="_blank">SurfaceThemes</a>.</span>
	 </p>';
