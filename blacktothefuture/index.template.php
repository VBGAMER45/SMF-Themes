...
<body>';
	...
	<div id="wrapper">
		<table width="100%" cellpadding="0" cellspacing="0" border="0"  align="center">
			<tr>
				<td align="center" class="bodyarea">
					<img src="', $settings['images_url'], '/logo.png" alt="" />
				</td>
			</tr>
		</table>
		<table width="100%" cellpadding="3" cellspacing="0" border="0"  align="center">
			<tr>
				<td valign="top" colspan="0" class="bodyarea">
		...
		<table cellspacing="0" cellpadding="3" border="0" align="center" width="100%">
			<tr>
				<td valign="middle" align="center" style="white-space: nowrap;">
					', theme_copyright(), ' <br /> Black To The Future by <a href="http://www.smfhacks.com" target="_blank">SMFHacks.com - SMF Mods</a>
				</td>
