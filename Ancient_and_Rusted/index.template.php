...
<tr>
<td colspan="2" width="100%" height="80px" align="left" valign="top" class="main-title">
<span class="title-text"><br />&nbsp;&nbsp;&nbsp;', $context['forum_name'], '</span></td>
</tr>
<tr>
<td width="312px" height="52px"><img src="', $settings['images_url'], '/logo_bottom.jpg" width="312px" height="52px" alt="0" /></td>
<td width="100%" height="52px" align="left" valign="top">
'; template_menu();
echo '
</td>
</tr>
...
function template_body_below()
{
	...
	<div id="footerarea" class="headerpadding topmargin clearfix">
		<ul class="reset smalltext">
			...
			<li><span class="smalltext">Theme by <a href="http://www.smfhacks.com" target="_blank" style="font-size:10px;">SMFHacks.com - SMF Mods</a>.</span></li>
