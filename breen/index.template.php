...
<body>';
	...
	echo '
        ...
        <td style="padding-left: 10px;">
          <img src="' , $settings['images_url'] , '/smflogo.png" alt="" />
         </td>
      </tr>	
		</table>
   		<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
...
function template_main_below()
{
	...
	<div id="footerarea" style="text-align: center; padding-bottom: 1ex;', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">
		...
		// ]]></script>
		<table cellspacing="0" cellpadding="3" border="0" align="center" width="1024">
			<tr>
				<td valign="middle" align="center" class="copy">
				Breen by <a href="http://www.smfhacks.com" target="_blank">SMFHacks.com - SMF Mods</a>
					<br />
					', theme_copyright(), '
				</td>
			</tr>
