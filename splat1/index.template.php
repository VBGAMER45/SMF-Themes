...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
	...
	if (!empty($settings['advert_control']) && !empty($settings['advert1']))
		dt();
...
function template_body_below()
{
	...
	<div id="footer_section">
		...
		<ul class="reset">
			...
			<li class="copyright"><strong>Splat:</strong> by <a href="http://www.smfhacks.com" target="_blank">SMFHacks.com - SMF Mods</a></li>';
			if (!empty($settings['cc_control']))
			{
			echo'
			', !empty($settings['cc']) ? '<li>'. parse_bbc($settings['cc']). '</li>' : '', '';
			}
			echo'
