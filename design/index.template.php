...
<body>';
	...
	<div ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' style="width: 100%;"' : '', '>
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td class="tabs" style="padding-left: 10px;" width="210px"><img src="' , $settings['images_url'] , '/logo.png" alt="" /></td>
				<td align="right">';
	...
	<div id="footerarea" style="text-align: center; padding-bottom: 1ex;', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">
		...
		<table cellspacing="0" cellpadding="3" border="0" align="center" width="100%">
			<tr>
				...
				Design by <a href="http://www.smfhacks.com" target="_blank">SMFHacks.com - SMF Mods</a>
					<br />
					', theme_copyright(), '
					<br />
					<a href="http://validator.w3.org/check?uri=referer" target="_blank">XHTML</a> | <a href="http://jigsaw.w3.org/css-validator/check/referer" target="_blank">CSS</a>
				</td>
			</tr>
		</table>';
