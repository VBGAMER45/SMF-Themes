	...
	<table border="0" width="100%" cellspacing="0" cellpadding="5">
		<tr>
			<td align="', !$context['right_to_left'] ? 'left' : 'right', '" class="smalltext">
				<img src="' . $settings['images_url'] . '/on.png" alt="" align="middle" height="16px" width="16px"/> ', $txt[333], '
				<img src="' . $settings['images_url'] . '/off.png" alt="" height="16px" width="16px" align="middle" style="margin-left: 4ex;" /> ', $txt[334], '
			</td>
